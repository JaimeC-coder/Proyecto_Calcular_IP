...
function broadcast() {
  ...
  respuestaTotal = respuestaA_Binario.split("").concat(respuestaB_Binario.split(""),respuestaC_Binario.split(""),respuestaD_Binario.split(""));
...
//valor inicial y completar de subredº
